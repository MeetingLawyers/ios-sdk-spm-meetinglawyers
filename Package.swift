...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "MeetingLawyersNSE",
            url: "https://meetinglawyers-ios-sdk.s3.eu-west-3.amazonaws.com/nse-sdk/2.0.0/MeetingLawyersNSE_2.0.0.zip",
            checksum: "35cf7231a3c8456b5cbd664c729464416ec5d7bacb88f4ff9bc73c7ce2334e1b"
        ),
        .target(
